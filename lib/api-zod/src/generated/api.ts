...
export const ListCollectiveOrdersResponse = zod.object({
  collectiveOrders: zod.array(
    zod.object({
      ...
      supplierId: zod.number().nullish(),
      supplierName: zod.string(),
      createdByBuyerId: zod.number().nullish(),
      ...
      collectiveStage: zod.enum(["gathering", "offers_open", "offer_selected", "allocations_confirming", "allocations_locked", "supplier_confirmed", "admin_review", "admin_approved", "execution", "completed", "cancelled"]).optional(),
      targetPrice: zod.number().nullish(),
      recommendedOfferId: zod.number().nullish(),
      selectedOfferId: zod.number().nullish(),
      isAllocationLocked: zod.boolean().optional(),
      isAllocationSharingApproved: zod.boolean().optional(),
      deadline: zod.string(),
...
export const GetCollectiveOrderResponse = zod
  ...
  .and(
    zod.object({
      ...
      deliveryRegionSummary: zod.array(zod.string()).optional(),
      offers: zod.array(zod.object({
        ...
        leadTime: zod.string(),
        incoterms: zod.array(zod.string()),
        paymentTerms: zod.string().nullish(),
        deliveryModel: zod.string(),
        deliveryCostMode: zod.string(),
      ...
      allocations: zod.array(zod.object({
        ...
        collectiveOrderId: zod.number(),
        buyerId: zod.number(),
        buyerCompanyName: zod.string().optional(),
        finalQty: zod.number(),
        unitPriceSnapshot: zod.number(),
        subtotalSnapshot: zod.number(),
